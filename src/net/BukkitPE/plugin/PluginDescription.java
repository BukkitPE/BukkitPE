...
public class PluginDescription {
     ...
     *
     * @return 这个插件支持的Nukkit API版本列表。<br>A list of all BukkitPE API versions String this plugin supports.
     * @see PluginDescription
     * @since BukkitPE 1.0 | BukkitPE API 1.0.0
     */
     ...
     * <p>
     * <p>Nukkit插件的依赖有这些注意事项：<br>Here are some note for BukkitPE plugin depending:
     * <ul>
