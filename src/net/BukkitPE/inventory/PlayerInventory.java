...
import net.BukkitPE.event.entity.EntityInventoryChangeEvent;
import net.BukkitPE.event.player.PlayerItemHeldEvent;
import net.BukkitPE.item.Item;
import net.BukkitPE.item.ItemBlock;
import net.BukkitPE.network.protocol.ContainerSetContentPacket;
import net.BukkitPE.network.protocol.ContainerSetSlotPacket;
import net.BukkitPE.network.protocol.MobArmorEquipmentPacket;
import net.BukkitPE.network.protocol.MobEquipmentPacket;
