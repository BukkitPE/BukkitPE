...
public class Level implements ChunkManager, Metadatable {
    ...
    public Level(Server server, String name, String path, Class<? extends LevelProvider> provider) {
        ...
        this.server.getLogger().info(this.server.getLanguage().translateString("BukkitPE.level.preparing", TextFormat.GREEN + this.provider.getName() + TextFormat.WHITE));
    ...
    public boolean unload(boolean force) {
        ...
        this.server.getLogger().info(this.server.getLanguage().translateString("BukkitPE.level.unloading", TextFormat.GREEN + this.getName() + TextFormat.WHITE));
