package net.BukkitPE.level.format.anvil;
...
public class Chunk extends BaseChunk {
    ...
    public Chunk(LevelProvider level, CompoundTag nbt) {
        ...
        net.BukkitPE.level.format.ChunkSection[] sections = new net.BukkitPE.level.format.ChunkSection[8];
        ...
        for (int Y = 0; Y < sections.length; ++Y) {
            net.BukkitPE.level.format.ChunkSection section = sections[Y];
            if (section != null) {
    ...
    public byte[] toFastBinary() {
        ...
        for (net.BukkitPE.level.format.ChunkSection section : this.getSections()) {
