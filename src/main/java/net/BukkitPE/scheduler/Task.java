 ...
 * <p>
 * <p>一个任务可以被BukkitPE服务器立即，延时，循环或延时循环执行。参见:{@link ServerScheduler}<br>
 * A task can be executed by BukkitPE server with a/an express, delay, repeat or delay&repeat.
