 ...
 * @see net.BukkitPE.OfflinePlayer
...
public interface IPlayer extends ServerOperator, Metadatable {
     ...
     * <p>
     * <p>如果是在线的玩家，这个函数只会返回登录名字。如果要返回显示的名字，参见{@link net.BukkitPE.Player#getDisplayName}<br>
     * Notice that this will only return its login name. If you need its display name, turn to
     * {@link net.BukkitPE.Player#getDisplayName}</p>
     *
     ...
     * @see net.BukkitPE.Server#isWhitelisted
     * @since BukkitPE 1.0 | BukkitPE API 1.0.0
     */
     ...
     * @see #isWhitelisted
     * @see net.BukkitPE.Server#addWhitelist
     * @see net.BukkitPE.Server#removeWhitelist
     * @since BukkitPE 1.0 | BukkitPE API 1.0.0
     */
     ...
     * @see net.BukkitPE.Server#getPlayerExact
     * @since BukkitPE 1.0 | BukkitPE API 1.0.0
     */
    Player getPlayer();
