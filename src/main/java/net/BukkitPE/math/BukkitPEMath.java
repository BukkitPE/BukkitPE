...
public class BukkitPEMath {
    ...
    public static int randomRange(BukkitPERandom random) {
        return randomRange(random, 0);
    }

    public static int randomRange(BukkitPERandom random, int start) {
        return randomRange(random, 0, 0x7fffffff);
    }

    public static int randomRange(BukkitPERandom random, int start, int end) {
