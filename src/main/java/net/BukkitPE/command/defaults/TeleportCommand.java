...
public class TeleportCommand extends VanillaCommand {
    ...
    public boolean execute(CommandSender sender, String commandLabel, String[] args) {
        ...
        if (args.length < 3) {
            ...
            Command.broadcastCommandMessage(sender, new TranslationContainer("commands.tp.success.coordinates", new String[]{target.getName(), String.valueOf(BukkitPEMath.round(x, 2)), String.valueOf(BukkitPEMath.round(y, 2)), String.valueOf(BukkitPEMath.round(z, 2))}));
            return true;
        }
        sender.sendMessage(new TranslationContainer("commands.generic.usage", this.usageMessage));
        return true;
