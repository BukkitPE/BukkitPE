...
public abstract class DefaultPermissions {
    public static final String ROOT = "BukkitPE";
    ...
    public static void registerCorePermissions() {
        Permission parent = registerPermission(new Permission(ROOT, "Allows using all BukkitPE commands and utilities"));
        ...
        Permission commands = registerPermission(new Permission(ROOT + ".command", "Allows using all BukkitPE commands"), parent);
