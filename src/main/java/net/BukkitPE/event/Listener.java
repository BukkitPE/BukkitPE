 ...
 * <p>
 * <p>事件监听器被注册后，BukkitPE会在需要监听的事件发生时，使用反射来调用监听类中对应的处理器。<br>
 * After registered, BukkitPE will call the handler in the listener classes by reflection when a event happens.</p>
 * <p>
 ...
 * </pre></p>
 *
 * <p>关于注册监听类，请看：{@link net.BukkitPE.plugin.PluginManager#registerEvents}.<br>
 * For registering listener class, See: {@link net.BukkitPE.plugin.PluginManager#registerEvents}.</p>
 *
