package net.BukkitPE.level.generator;
...
import net.BukkitPE.level.generator.biome.BiomeSelector;
import net.BukkitPE.level.generator.noise.Simplex;
import net.BukkitPE.level.generator.object.ore.OreType;
import net.BukkitPE.level.generator.populator.Populator;
import net.BukkitPE.level.generator.populator.PopulatorCaves;
import net.BukkitPE.level.generator.populator.PopulatorGroundCover;
import net.BukkitPE.level.generator.populator.PopulatorOre;
...
public class Normal extends Generator {
    ...
    @Override
    public void init(ChunkManager level, BukkitPERandom random) {
        this.level = level;
        this.random = random;
