...
public abstract class ObjectTree {
    ...
    public static void growTree(ChunkManager level, int x, int y, int z, BukkitPERandom random, int type) {
        ObjectTree tree;
        switch (type) {
    ...
    protected void placeTrunk(ChunkManager level, int x, int y, int z, BukkitPERandom random, int trunkHeight) {
        // The base dirt block
