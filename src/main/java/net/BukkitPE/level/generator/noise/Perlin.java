...
public class Perlin extends Noise {
    ...
    public Perlin(BukkitPERandom random, double octaves, double persistence) {
        this(random, octaves, persistence, 1);
    }

    public Perlin(BukkitPERandom random, double octaves, double persistence, double expansion) {
