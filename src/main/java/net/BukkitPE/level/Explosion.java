...
import net.BukkitPE.event.entity.EntityExplodeEvent;
...
import net.BukkitPE.network.protocol.ExplodePacket;
...
public class Explosion {
    ...
    public boolean explodeB() {
        ...
        double minX = BukkitPEMath.floorDouble(this.source.x - explosionSize - 1);
        double maxX = BukkitPEMath.ceilDouble(this.source.x + explosionSize + 1);
        double minY = BukkitPEMath.floorDouble(this.source.y - explosionSize - 1);
        double maxY = BukkitPEMath.ceilDouble(this.source.y + explosionSize + 1);
        double minZ = BukkitPEMath.floorDouble(this.source.z - explosionSize - 1);
        double maxZ = BukkitPEMath.ceilDouble(this.source.z + explosionSize + 1);
