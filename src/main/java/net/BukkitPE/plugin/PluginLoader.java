...
public interface PluginLoader {
     ...
     * @see #loadPlugin(File)
     * @see net.BukkitPE.plugin.PluginBase#init(PluginLoader, net.BukkitPE.Server, PluginDescription, File, File)
     * @since BukkitPE 1.0 | BukkitPE API 1.0.0
     */
     ...
     * <p>
     * <p>在BukkitPE读取所有插件时，插件管理器会查找所有已经安装的插件加载器，通过识别这个插件是否满足下面的条件，
     * 来选择对应的插件加载器。<br>
     * When BukkitPE is trying to load all its plugins, the plugin manager will look for all installed plugin loader,
