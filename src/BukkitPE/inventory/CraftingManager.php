...
use BukkitPE\block\Planks;
use BukkitPE\block\Wood;
use BukkitPE\block\Wood2;
use BukkitPE\item\Item;
use BukkitPE\utils\UUID;
use BukkitPE\item\Potion;
use BukkitPE\item\Fish;
...
class CraftingManager{
	...
	private function createOneIngedientRecipe($recipeshape, $resultitem, $resultitemmeta, $resultitemamound, $ingedienttype, $ingredientmeta, $ingredientname, $inventoryType = ""){
		...
		if ($height < 3){
			...
			$fullClassName = "BukkitPE\\inventory\\".$inventoryType."ShapedRecipe";// $ShapeClass."ShapedRecipe";
			...
			// Process big recipe
			$fullClassName = "BukkitPE\\inventory\\".$inventoryType."BigShapedRecipe";
			$recipe = ((new $fullClassName(Item::get($resultitem, $resultitemmeta, $resultitemamound),
				...$recipeshape
			))->setIngredient($ingredientname, Item::get($ingedienttype, $ingredientmeta, $ingredientamount)));
		}
