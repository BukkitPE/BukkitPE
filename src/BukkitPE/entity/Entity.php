...
use BukkitPE\block\Portal;
use BukkitPE\block\Water;
use BukkitPE\event\entity\EntityDamageEvent;
use BukkitPE\event\entity\EntityDespawnEvent;
use BukkitPE\event\entity\EntityLevelChangeEvent;
use BukkitPE\event\entity\EntityMotionEvent;
use BukkitPE\event\entity\EntityRegainHealthEvent;
use BukkitPE\event\entity\EntitySpawnEvent;
use BukkitPE\event\entity\EntityTeleportEvent;
...
use BukkitPE\Server;
use BukkitPE\utils\ChunkException;
use BukkitPE\event\entity\EntityDamageByChildEntityEvent;
...
abstract class Entity extends Location implements Metadatable{
	...
	/** @var \BukkitPE\event\TimingsHandler */
	protected $timings;
