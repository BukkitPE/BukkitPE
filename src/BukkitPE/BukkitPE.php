...
namespace BukkitPE {
	...
	if(\Phar::running(true) !== ""){
		@define("BukkitPE\\PATH", \Phar::running(true) . "/");
	}else{
		@define("BukkitPE\\PATH", \getcwd() . DIRECTORY_SEPARATOR);
	}
	...
	if(!class_exists("ClassLoader", false)){
		require_once(\BukkitPE\PATH . "src/spl/ThreadedFactory.php");
		require_once(\BukkitPE\PATH . "src/spl/ClassLoader.php");
		require_once(\BukkitPE\PATH . "src/spl/BaseClassLoader.php");
		require_once(\BukkitPE\PATH . "src/BukkitPE/CompatibleClassLoader.php");
	}

	$autoloader = new CompatibleClassLoader();
	$autoloader->addPath(\BukkitPE\PATH . "src");
	$autoloader->addPath(\BukkitPE\PATH . "src" . DIRECTORY_SEPARATOR . "spl");
	...
	function cleanPath($path){
		return rtrim(str_replace(["\\", ".php", "phar://", rtrim(str_replace(["\\", "phar://"], ["/", ""], \BukkitPE\PATH), "/"), rtrim(str_replace(["\\", "phar://"], ["/", ""], \BukkitPE\PLUGIN_PATH), "/")], ["/", "", "", "", ""], $path), "/");
	}
	...
	if(file_exists(\BukkitPE\PATH . ".git/refs/heads/master")){ //Found Git information!
