...
use BukkitPE\entity\Arrow;
use BukkitPE\entity\Boat;
use BukkitPE\entity\AttributeManager;
...
use BukkitPE\event\block\SignChangeEvent;
...
use BukkitPE\event\entity\EntityRegainHealthEvent;
use BukkitPE\event\entity\EntityShootBowEvent;
use BukkitPE\event\entity\ProjectileLaunchEvent;
use BukkitPE\event\inventory\CraftItemEvent;
use BukkitPE\event\inventory\InventoryCloseEvent;
use BukkitPE\event\inventory\InventoryPickupArrowEvent;
use BukkitPE\event\inventory\InventoryPickupItemEvent;
use BukkitPE\event\player\PlayerAchievementAwardedEvent;
use BukkitPE\event\player\PlayerAnimationEvent;
use BukkitPE\event\player\PlayerBedEnterEvent;
use BukkitPE\event\player\PlayerBedLeaveEvent;
...
use BukkitPE\event\player\PlayerDropItemEvent;
use BukkitPE\event\player\PlayerGameModeChangeEvent;
use BukkitPE\event\player\PlayerHungerChangeEvent;
use BukkitPE\event\player\PlayerInteractEvent;
use BukkitPE\event\player\PlayerItemConsumeEvent;
use BukkitPE\event\player\PlayerJoinEvent;
use BukkitPE\event\player\PlayerKickEvent;
use BukkitPE\event\player\PlayerLoginEvent;
...
use BukkitPE\event\player\PlayerToggleSneakEvent;
use BukkitPE\event\player\PlayerToggleSprintEvent;
use BukkitPE\event\server\DataPacketReceiveEvent;
use BukkitPE\event\server\DataPacketSendEvent;
use BukkitPE\event\TextContainer;
use BukkitPE\event\Timings;
use BukkitPE\event\TranslationContainer;
use BukkitPE\inventory\BaseTransaction;
use BukkitPE\inventory\BigShapedRecipe;
use BukkitPE\inventory\BigShapelessRecipe;
use BukkitPE\inventory\FurnaceInventory;
use BukkitPE\inventory\Inventory;
use BukkitPE\inventory\InventoryHolder;
use BukkitPE\inventory\PlayerInventory;
use BukkitPE\inventory\ShapedRecipe;
use BukkitPE\inventory\ShapelessRecipe;
use BukkitPE\inventory\SimpleTransactionGroup;
use BukkitPE\item\Item;
use BukkitPE\item\Launchable;
use BukkitPE\item\Food;
use BukkitPE\level\ChunkLoader;
use BukkitPE\level\format\FullChunk;
use BukkitPE\level\Level;
use BukkitPE\level\Location;
use BukkitPE\level\Position;
use BukkitPE\level\sound\LaunchSound;
use BukkitPE\math\AxisAlignedBB;
use BukkitPE\math\Vector2;
...
class Player extends Human implements CommandSender, InventoryHolder, ChunkLoader, IPlayer{
	...
	protected function processLogin(){
		...
		$this->server->getLogger()->info($this->getServer()->getLanguage()->translateString("BukkitPE.player.logIn", [
	...
	public function sendTranslation($message, array $parameters = []){
		...
		if(!$this->server->isLanguageForced()){
			...
			foreach($parameters as $i => $p){
				$parameters[$i] = $this->server->getLanguage()->translateString($p, $parameters, "BukkitPE.");
			}
	...
	public final function close($message = "", $reason = "generic reason", $notify = true){
		if($this->connected and !$this->closed){
			...
			$this->server->getPluginManager()->unsubscribeFromPermission(Server::BROADCAST_CHANNEL_USERS, $this);
			$this->spawned = false;
			$this->server->getLogger()->info($this->getServer()->getLanguage()->translateString("BukkitPE.player.logOut", [
