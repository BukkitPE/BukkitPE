...
class InstallerLang{
	...
	public function __construct($lang = ""){
		if(file_exists(\BukkitPE\PATH . "src/BukkitPE/lang/Installer/" . $lang . ".ini")){
			$this->lang = $lang;
			$this->langfile = \BukkitPE\PATH . "src/BukkitPE/lang/Installer/" . $lang . ".ini";
		}else{
			$files = [];
			foreach(new \DirectoryIterator(\BukkitPE\PATH . "src/BukkitPE/lang/Installer/") as $file){
			...
			if(count($files) > 0){
				...
				$this->langfile = \BukkitPE\PATH . "src/BukkitPE/lang/Installer/" . $l . ".ini";
			}else{
				$this->lang = "en";
				$this->langfile = \BukkitPE\PATH . "src/BukkitPE/lang/Installer/en.ini";
			}
		}

		$this->loadLang(\BukkitPE\PATH . "src/BukkitPE/lang/Installer/en.ini", "en");
		if($this->lang !== "en"){
